#!/bin/bash
# GAAJU-MD Fly.io One-Click Deployer
# Usage: bash <(curl -s https://raw.githubusercontent.com/Xchristech2/GAAJU-MD/main/lib/fly.sh)
...
read -p "$(echo -e ${CYAN}Session ID (GlobalTechInfo/GAAJU-MD_xxxxx): ${NC})" SESSION_ID
...
if [ ! -f "fly.toml" ]; then
    ...
    git clone https://github.com/Xchristech2/GAAJU-MD gaaju-md-deploy
    cd gaaju-md-deploy
fi
